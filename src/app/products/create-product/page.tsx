        ...
        <div className="max-w-md mx-auto mt-8 p-6 bg-white rounded shadow-lg">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                <div>
                    ...
                    <input {...register('title')} id="title" className="w-full border rounded-lg px-3 py-2 focus:outline-none" />
                </div>
                <div>
                    <label htmlFor="price" className="block font-semibold mb-1">Product Price</label>
                    <input {...register('price', { valueAsNumber: true })} id="price" type="number" className="w-full border rounded-lg px-3 py-2 focus:outline-none" />
                </div>
                <div>
                    <label htmlFor="description" className="block font-semibold mb-1">Product Description</label>
                    <textarea {...register('description')} id="description" className="w-full border rounded-lg px-3 py-2 focus:outline-none" />
                </div>
                <div>
                    <label htmlFor="category" className="block font-semibold mb-1">Category</label>
                    <input {...register('category')} id="category" className="w-full border rounded-lg px-3 py-2 focus:outline-none" />
                </div>
                <div>
                    <label htmlFor="image" className="block font-semibold mb-1">Product Image URL</label>
                    <input {...register('image')} id="image" className="w-full border rounded-lg px-3 py-2 focus:outline-none" />
                </div>
